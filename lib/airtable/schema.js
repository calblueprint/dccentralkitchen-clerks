...
export const Columns = {
  Customers: {
    ...
    generalNotifications: { name: `General Notifications`, type: `multiSelect` },
    deliveryNotifications: { name: `Delivery Notifications`, type: `multiSelect` },
  },
  Clerks: {
    primaryKey: { name: `Primary Key`, type: `formula` },
  ...
  Stores: {
    ...
    favoritedCustomerIds: { name: `Favorited Customers`, type: `foreignKey-many` },
  ...
  Transactions: {
    primaryKey: { name: `Primary Key`, type: `formula` },
    storeId: { name: `Store`, type: `foreignKey-one` },
    productsPurchasedIds: { name: `Products Purchased`, type: `foreignKey-many` },
