...
export const Columns = {
  ...
  Transactions: {
    ...
    totalPrice: { name: `Total Price`, type: `number` },
  ...
  'Clerk Feedback': {
    ...
    attachments: { name: `Attachments`, type: `multipleAttachment` },
    details: { name: `Details`, type: `multilineText` },
    storeNameId: { name: `Store Name`, type: `foreignKey-one` },
    role: { name: `Role`, type: `multiSelect` },
    otherRole: { name: `Other Role`, type: `text` },
  },
  News: {
    primaryKey: { name: `Primary Key`, type: `formula` },
    created: { name: `Created`, type: `formula` },
