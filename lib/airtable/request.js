...
export const createCustomerFeedback = async record => {
  return createRecord(Tables.CustomerFeedback, record);
};

export const createClerkFeedback = async record => {
  return createRecord(Tables.ClerkFeedback, record);
};
...
export const getCustomersByPhoneNumber = async (value, sort = []) => {
  return getRecordsByAttribute(Tables.Customers, Columns[Tables.Customers].phoneNumber.name, value, sort);
};
...
export const getClerksByStoreId = async (value, sort = []) => {
  return getRecordsByAttribute(Tables.Clerks, Columns[Tables.Clerks].storeId.name, value, sort);
};
...
export const getCustomerFeedbackById = async id => {
  return getRecordById(Tables.CustomerFeedback, id);
};

export const getCustomerFeedbacksByIds = async ids => {
  const formula = `OR(${ids.reduce((f, id) => `${f} {ID}='${id}',`, '')} 1 < 0)`;
  return getAllRecords(Tables.CustomerFeedback, formula);
};

export const getAllCustomerFeedbacks = async (filterByFormula = '', sort = []) => {
  return getAllRecords(Tables.CustomerFeedback, filterByFormula, sort);
};

export const getClerkFeedbackById = async id => {
  return getRecordById(Tables.ClerkFeedback, id);
};

export const getClerkFeedbacksByIds = async ids => {
  const formula = `OR(${ids.reduce((f, id) => `${f} {ID}='${id}',`, '')} 1 < 0)`;
  return getAllRecords(Tables.ClerkFeedback, formula);
};

export const getAllClerkFeedbacks = async (filterByFormula = '', sort = []) => {
  return getAllRecords(Tables.ClerkFeedback, filterByFormula, sort);
};
...
export const updateCustomerFeedback = async (id, recordUpdates) => {
  return updateRecord(Tables.CustomerFeedback, id, recordUpdates);
};

export const updateClerkFeedback = async (id, recordUpdates) => {
  return updateRecord(Tables.ClerkFeedback, id, recordUpdates);
};
...
export const deleteCustomerFeedback = async id => {
  return deleteRecord(Tables.CustomerFeedback, id);
};
export const deleteClerkFeedback = async id => {
  return deleteRecord(Tables.ClerkFeedback, id);
};
