...
export const getCustomerssByPhoneNumber = async value => {
  return getRecordsByAttribute(Tables.Customers, Columns[Tables.Customers].phoneNumber, value);
};
...
export const getClerkssByStoreId = async value => {
  return getRecordsByAttribute(Tables.Clerks, Columns[Tables.Clerks].storeId, value);
};
...
export const getAllResourcess = async () => {
  return getAllRecords(Tables.Resources);
};
...
export const getAllCustomerFeedbacks = async () => {
  return getAllRecords(Tables.CustomerFeedback);
};
...
export const getAllClerkFeedbacks = async () => {
  return getAllRecords(Tables.ClerkFeedback);
};
