...
export async function lookupClerk(storeId, password) {
  ...
  let errorMsg = 'Incorrect store name and password combination. Please try again.';
  ...
  errorMsg =
    'Database error: more than one clerk found with this login info at this store. Please alert an admin to fix this issue for you!';
