...
export async function addTransaction(customer, cart, pointsEarned, totalBalance, rewardsApplied) {
  ...
  console.log('subtotal', subtotal, 'actualDiscount', actualDiscount, 'totalSale', totalSale);
